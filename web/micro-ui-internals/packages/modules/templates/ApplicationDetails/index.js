...
// importing jsonData from pet.json
...
const ApplicationDetails = (props) => {
  ...
  const {
    applicationDetails,// added jsonAppDetailsToShow
      ...
      {!isLoading ? (
        <React.Fragment>
          <ApplicationDetailsContent
            ...
            //applicationDetails={jsonData}
            // changes made here ... passing new prop named jsonData
           jsonAppDetailsToShow={jsonAppDetailsToShow}
